...
const FlashcardScreen: React.FC<FlashcardScreenProps> = ({ wordId }) => {
  ...
  const explainGrammaticalForms = (form: string, isVerb: boolean): string => {
    ...
    const nounEndingsMap = [
      ...
      { ending: "į", translation: "(dat. sing. - to)" },
      ...
      { ending: "os", translation: "(fem. pl./gen. pl. - of)" },
      ...
      // Locative Endings
      { ending: "oje", translation: "(in/at sing.)" },
      { ending: "ėje", translation: "(in/at sing.)" },
      { ending: "uose", translation: "(in/at pl.)" },
      { ending: "iuose", translation: "(in/at pl.)" },
    ];
